...
try {
    $sql = "UPDATE tbl_temp_manuscript SET temp_manu_title=:manu_title, temp_manu_sub=:manu_sub,temp_manu_abstract=:manu_abstract,temp_manu_keywords=:manu_keywords WHERE temp_manu_id='$lastId'";
