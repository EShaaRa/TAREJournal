    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="wizard-steps">  
                ...
                <div class="active-step"><a href="reManuInfo.php">Manuscript information</a></div>
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <div class="form-group">
                    ...
                    <div class="pull-right">
                        <button id="btnPreviousToUpload" class="btn btn-rounded" onclick="window.location.href = 'ReUpload.php'">&laquo;&nbsp;Previous</button>
                    </div>
                    <div>&emsp;</div>
                </div>
            </div>
