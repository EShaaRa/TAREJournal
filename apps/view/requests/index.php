            ...
            <div class="col-lg-6 col-lg-offset-3 col-md-8 col-sm-12">
                <div class="panel panel-success text-center">
                    <div class="panel-heading">
                        <h3 class="panel-title">Reviewer Request</h3> 
                        <?php $template->showMessage(); ?>
                    </div>

                    <div class="panel-body">
                        <form id="frmEditUser" action="../../../apps/model/requests/_index.php" method="post" enctype="multipart/form-data"> 
...
<!--                                <tr>
                                ...
                                <tr> <td>&nbsp;</td></tr>
                                <tr>
                                    <td><input type="submit" id="btnAccept" class="btn btn-success" value="Accept" name="acceptReviewer"/> </td>
                                    <td align="right"><input type="button" id="btnReject" class="btn btn-success" value="Reject"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
